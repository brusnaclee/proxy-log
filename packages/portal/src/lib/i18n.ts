...
const dict: Record<string, Record<Lang, string>> = {
  ...
  "This key today": { id: "Key ini hari ini", en: "This key today" },
  "Account shared today": { id: "Akun shared hari ini", en: "Account shared today" },
  "Contribution only — limits stay on the shared account pool.": {
    id: "Kontribusi saja — limit tetap di pool shared akun.",
    en: "Contribution only — limits stay on the shared account pool.",
  },
  "Show usage & devices": { id: "Tampilkan usage & perangkat", en: "Show usage & devices" },
  "Hide details": { id: "Sembunyikan detail", en: "Hide details" },
  ...
  "Token Usage by Model": { id: "Token per Model", en: "Tokens by Model" },
