...
export const adminConfig = pgTable('admin_config', {
	...
	tokenSaverGroupyCompactMode: text('token_saver_groupy_compact_mode').notNull().default('preset'),
	tokenSaverGroupyCompactCustom: text('token_saver_groupy_compact_custom').notNull().default('{}'),
	tokenSaverBatchEnabled: boolean('token_saver_batch_enabled').notNull().default(true),
	tokenSaverBatchMode: text('token_saver_batch_mode').notNull().default('preset'),
	tokenSaverBatchLevel: text('token_saver_batch_level').notNull().default('balanced'),
	tokenSaverBatchCustom: text('token_saver_batch_custom').notNull().default('{}'),
	tokenSaverRtkMode: text('token_saver_rtk_mode').notNull().default('preset'),
	tokenSaverRtkLevel: text('token_saver_rtk_level').notNull().default('balanced'),
	tokenSaverRtkCustom: text('token_saver_rtk_custom').notNull().default('{}'),
	tokenSaverHeadroomMode: text('token_saver_headroom_mode').notNull().default('preset'),
	tokenSaverHeadroomLevel: text('token_saver_headroom_level').notNull().default('balanced'),
	tokenSaverHeadroomCustom: text('token_saver_headroom_custom').notNull().default('{}'),
	tokenSaverCavemanMode: text('token_saver_caveman_mode').notNull().default('preset'),
	tokenSaverCavemanCustom: text('token_saver_caveman_custom').notNull().default('{}'),
	tokenSaverPonytailMode: text('token_saver_ponytail_mode').notNull().default('preset'),
	tokenSaverPonytailCustom: text('token_saver_ponytail_custom').notNull().default('{}'),
	tokenSaverAntiWasteEnabled: boolean('token_saver_anti_waste_enabled').notNull().default(true),
...
export const userPortalSettings = pgTable('user_portal_settings', {
  ...
  tokenSaverAntiWasteOverride: boolean('token_saver_anti_waste_override'),
  tokenSaverRtkModeOverride: text('token_saver_rtk_mode_override'),
  tokenSaverRtkLevelOverride: text('token_saver_rtk_level_override'),
  tokenSaverRtkCustomOverride: text('token_saver_rtk_custom_override'),
  tokenSaverHeadroomModeOverride: text('token_saver_headroom_mode_override'),
  tokenSaverHeadroomLevelOverride: text('token_saver_headroom_level_override'),
  tokenSaverHeadroomCustomOverride: text('token_saver_headroom_custom_override'),
  tokenSaverCavemanModeOverride: text('token_saver_caveman_mode_override'),
  tokenSaverCavemanLevelOverride: integer('token_saver_caveman_level_override'),
  tokenSaverCavemanCustomOverride: text('token_saver_caveman_custom_override'),
  tokenSaverPonytailModeOverride: text('token_saver_ponytail_mode_override'),
  tokenSaverPonytailLevelOverride: text('token_saver_ponytail_level_override'),
  tokenSaverPonytailCustomOverride: text('token_saver_ponytail_custom_override'),
  tokenSaverGroupyCompactModeOverride: text('token_saver_groupy_compact_mode_override'),
  tokenSaverGroupyCompactLevelOverride: text('token_saver_groupy_compact_level_override'),
  tokenSaverGroupyCompactCustomOverride: text('token_saver_groupy_compact_custom_override'),
  tokenSaverBatchModeOverride: text('token_saver_batch_mode_override'),
  tokenSaverBatchLevelOverride: text('token_saver_batch_level_override'),
  tokenSaverBatchCustomOverride: text('token_saver_batch_custom_override'),
