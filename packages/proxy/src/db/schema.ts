...
export const adminConfig = sqliteTable("admin_config", {
  ...
  realtimeEnabled: integer("realtime_enabled", { mode: "boolean" }).default(false),
  ...
  verifAutoEnabled: integer("verif_auto_enabled", { mode: "boolean" }).default(false),
...
export const allowedIdes = sqliteTable("allowed_ides", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  apiKeyId: integer("api_key_id").notNull().references(() => apiKeys.id, { onDelete: "cascade" }),
...
export const chatSessions = sqliteTable("chat_sessions", {
  ...
  lastToolCallsActive: integer("last_tool_calls_active", { mode: "boolean" }).default(false),
